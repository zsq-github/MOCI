...
class UserEquipment:
    ...
    # Initialize user device location information
    ...
    #Initialize user device actions
    ...
    # Initialize User Device Statistics
    def statistic_init(self):
        self.time_used = 0
        self.energy_used = 0
        self.finished_num = 0

    # User equipment processing for task completion
    ...
    # Simulate the process of receiving a task on the user's device
    ...
    # Verify that the user device is currently in local mode
